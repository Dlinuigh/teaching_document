...
\begin{document}
	...
	\begin{tabularx}{\columnwidth}{XX}
		...
		包含纯电阻电源输出功率&$P=(\frac{E}{R+r})^2R\le \frac{E^2}{4r}$\\
		电源效率&$\eta=\frac{P_{\text{输出}}}{P_{\text{总}}}=\frac U E=\frac{R}{R+r}$\\
	\end{tabularx}
	\textit{上面的小于等于的意思是，存在一个极大值。}\\
	\hint{
		\begin{itemize}
	...
	\hint{
		...
		\draw (5,14.5) to[short] (5,15.75);
		\draw (6.25,14.5) to[battery ] (7.5,14.5);
		\draw (7.5,14.5) to[normal open switch] (8.75,14.5);
		\draw (5,14.5) to[short] (6.25,14.5);
		\draw (8.75,14.5) to[short] (10,14.5);
		\draw (7.5,16.25) to[short] (7.5,17);
		\draw (7.5,17) to[short] (10,17);
		\draw (10,14.5) to[short] (10,15.75);
		\draw (6.25,18.25) to[european resistor,l={ \LARGE $R_L$}] (8.75,18.25);
		\draw (6.25,18.25) to[short] (5,18.25);
		\draw (8.75,18.25) to[short] (10,18.25);
		\draw (10,18.25) to[short] (10,17);
		\draw (5,15.75) to[rmeter, t=A] (5,18.25);
		\draw (5,18.25) to[short] (5,19.5);
		\draw (5,19.5) to[short] (6.25,19.5);
		\draw (8.75,19.5) to[short] (10,19.5);
		\draw (10,19.5) to[short] (10,18.25);
		\draw (6.25,19.5) to[rmeter, t=V] (8.75,19.5);
		\draw (5,15.75) to[potentiometer] (10,15.75);
		\end{circuitikz}
	% 	}
	% 	\label{fig:my_label}
	% \end{figure}
